export default function Navbar() {
    return (
        <nav className="w-full  bg-snowWhite text-smokyBlack font-heading flex items-center justify-between p-20 md:px-8 lg:px-16 sticky top-0 left-0 z-50">
            ...
            <div>
                <ul className="hidden md:flex gap-8 text-xl p-20">
            ...
            <div className="md:hidden cursor-pointer p-20">
